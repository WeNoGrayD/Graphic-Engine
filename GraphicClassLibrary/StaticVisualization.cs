...
{ 
    ...
    public partial class StaticVisualization : Form
    {
        ...
        public StaticVisualization()
        {
            ...
            Spectator = new Observer(new Point3D(250, 130, 0),
            ...
            Pyramid =
                new Object3D(new Point3D(0, 130, 0),
                             90,
            ...
            Pyramid.InitVertexes(_vertexes);
            /*
            Object3D P1 = Pyramid.Clone();
            P1.CenterPoint["WCS"] = new Point3D(-500, 130, 0);
            
            P1.Name = "lalala1";

            Stage.AddObject(P1);

            List<Point3D> _vertexesP1 = new List<Point3D>(_vertexes);

            P1.InitVertexes(_vertexesP1);

            Object3D P2 = Pyramid.Clone();
            P2.CenterPoint["WCS"] = new Point3D(-250, 600, 0);
            ...
            P2.InitVertexes(_vertexesP2);

            Object3D P3 = Pyramid.Clone();
            P3.CenterPoint["WCS"] = new Point3D(-650, 600, 0);
            ...
            P3.InitVertexes(_vertexesP3);

            Object3D P4 = Pyramid.Clone();
            P4.CenterPoint["WCS"] = new Point3D(-550, 600, 0);
            ...
            Dictionary<string, Dictionary<string, double[,]>> UpdateMatrices)
        {
            ...
            foreach (IObjectOnStage obj in Stage.Objects.Values)
            {
                ...
                if (!obj.Name.Equals("Spectator"))
                    obj.UpdateVertexes('a', UpdateMatrices[obj.Name]);
            }
        ...
        public void Observer_KeyDown(Keys keyData)
        {
            ...
            void TransitObserver(char axe, float delta, List<string> CSs)
            {
                ...
                Spectator.UpdateVertexes(' ', UpdateMatrices);
            }
