...
{ 
    ...
    public partial class StaticVisualization : Form
    {
        ...
        public StaticVisualization()
        {
            ...
            Pyramid =
                new Object3D(new Point3D(-125, 125, -100),
                             90,
            ...
            Pyramid.Ka = 0.45F;
            foreach (Polygon poly in Pyramid.Polygons)
            {
                poly.Kd = 0.5F;
                poly.Ks = 0.5F;
                poly.n = 1;
            ...
            P2.CenterPoint["WCS"] = new Point3D(125, 125, 100);
            ...
            P2.Ka = 0.45F;
            foreach (Polygon poly in P2.Polygons)
            {
                poly.Kd = 1;
                poly.Ks = 0.9F;
                poly.n = 2;
            ...
            P3.CenterPoint["WCS"] = new Point3D(125, -150, -100);
            ...
            P3.Ka = 0.45F;
            foreach (Polygon poly in P3.Polygons)
            {
                poly.Kd = 0.4F;
                poly.Ks = 0.6F;
                poly.n = 3;
            ...
            P4.CenterPoint["WCS"] = new Point3D(-125, -150, 100);
            ...
            P4.Ka = 0.45F;
            foreach (Polygon poly in P4.Polygons)
            {
                poly.Kd = 0.65F;
                poly.Ks = 0.35F;
                poly.n = 5;
            ...
            List<LightSource> lbs = new List<LightSource>();
            foreach (LightSource lb in Stage.Objects.Values.Where(o => o is LightSource))
                lbs.Add(lb);
            lbs[0].LocationPoint["WCS"] = new Point3D(140, -20, 67);
            lbs[1].LocationPoint["WCS"] = new Point3D(205, 185, 31);
            lbs[2].LocationPoint["WCS"] = new Point3D(16, 31, 2);
            lbs[3].LocationPoint["WCS"] = new Point3D(56, -69, 80);
        }
        ...
        /* Создание заданного количества звёзд
           со случайным цветом и расположением на сцене. */

        public void LightBulbs_Init(int lbCount)
        {
            Random rX = new Random(78243823);
            Random rY = new Random(98347934);
            Random rZ = new Random(290765147);
            Random rRGB = new Random(345828);

            for (int i = 0; i < lbCount; i++)
            {
                int X = (int)(rX.NextDouble() * Stage.Xmax),
                    Y = (int)(rY.NextDouble() * Stage.Ymax),
                    Z = (int)(rZ.NextDouble() * Stage.Zmax);
